...
class TestSlugify(unittest.TestCase):
    def test_simple_name(self):
        self.assertEqual(dev_loop.slugify_repo_name("example-org/a-private-repo"), "a-private-repo")
    ...
    def test_skill_slug_appends_dev_loop_suffix(self):
        self.assertEqual(dev_loop.skill_slug("example-org/a-private-repo"), "a-private-repo-dev-loop")
